    ...
    displayedPermissions: function () {
      if ((this as any).mode === Mode.Organization) {
        ...
        return [
          {
            label: 'Admin',
            message: 'User has all rights on organization, can create and write in projects but not administrate projects they\'re not admin of',
      ...
      return [
        ...
        {
          label: 'Pull features',
          message: 'User is able to pull features as Gherkin code using command line',
