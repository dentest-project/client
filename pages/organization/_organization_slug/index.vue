<template>
  <v-main>
    ...
    <actions-bar v-if="$auth.loggedIn && isOrganizationUser">
      ...
      <exit-button v-if="isOrganizationUser" label="Leave organization" @click="activateLeaveOrganizationDialog" />
    ...
    <leave-organization-dialog v-model="leaveOrganizationDialog" :organization="organization" @close="deactivateLeaveOrganizationDialog" @deleted="onOrganizationLeft" @errored="onOrganizationLeaveErrored" />
    ...
    <v-snackbar v-model="organizationLeftSnackbarOpened" :color="$colors.success">Organization left</v-snackbar>
    ...
    <v-snackbar v-model="organizationLeaveErrorSnackbarOpened" :color="$colors.error">An error occurred while leaving the organization</v-snackbar>
...
export default Vue.extend({
  ...
  computed: {
    ...
    isOrganizationUser: function (): boolean {
      return typeof ((this as any).organization as Organization).permissions.find(p => p === OrganizationPermission.Admin || p === OrganizationPermission.ProjectWrite || p === OrganizationPermission.ProjectCreate || p === OrganizationPermission.Read) !== 'undefined';
    },
